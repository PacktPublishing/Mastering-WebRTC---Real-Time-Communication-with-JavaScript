...
let iceCandidatesGenerated = []; // for learning purposes, we will store all ice candidates generated inside of an array
...
function createPeerConnectionObject() {
    ...
    pc.addEventListener("connectionstatechange", () => {
        ...
        if(pc.connectionState === "connected") {
            ...
            // later, we'll have up update UI to remove all learning buttons, and allow users to insert text
        }
    });
...
function registerDataChannelEventListeners() {
    dataChannel.addEventListener("message", (e) => {
        ...
        // later, we can implement logic to add the message to the users frontend
    });
